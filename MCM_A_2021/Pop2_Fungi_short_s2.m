...
xlabel('days'); ylabel('population'); legend(' population 1', ' population 3')
...
xlabel('days'); ylabel('growth rate'); legend(' population 1', ' population 3')
...
axis([0 tspan2(length(tspan2)) 0 500])
