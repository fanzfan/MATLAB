...
Wv1 = @(t) (1 + 1 * v(t)) .* (0.2*heaviside(hu(fix(t))-60)-0.1*heaviside(-hu(fix(t))+60));
Wv2 = @(t) (1 + 3 * v(t)) .* (0.2*heaviside(hu(fix(t))-60)-0.1*heaviside(-hu(fix(t))+60));
